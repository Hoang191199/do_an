                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/all-category-product') }}">Quản lý danh mục sản phẩm</a>
                                </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/all-brand-product') }}">Quản lý thương hiệu sản phẩm</a>
                                </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{ URL::to('/select-feeship') }}">Danh sách phí vận chuyển</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
        ...
        <section id="main-content">
            ...
            <div class="footer">
                <div class="wthree-copyright">
                    <p>© 2021 Copyright. Well come to <a href="/all-product"> Administration </a></p>
                </div>
            </div>
            <!-- / footer -->
        </section>
        ...
        $(document).on('blur', '.edit_gal_name', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    load_gallery();
                    $('#error_gallery').html(
                        '<span class="text-success">Cập nhật tên hình ảnh thành công</span>');
                }
            });
        });
            ...
            if (confirm('Bạn muốn xóa hình ảnh này không?')) {
                $.ajax({
                    ...
                    success: function(data) {
                        load_gallery();
                        $('#error_gallery').html(
                            '<span class="text-success">Xóa hình ảnh thành công</span>');
                    }
                });
            }
        });
