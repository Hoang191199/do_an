                        ...
                        <form role="form" action="{{ URL::to('/save-category-product') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min3"
                                    data-validation-error-msg="Vui lòng điền tên danh mục ít nhất 3 ký tự"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" data-validation="length" data-validation-length="min3"
                                    data-validation-error-msg="Vui lòng điền từ khóa danh mục ít nhất 3 ký tự" rows="8"
                                    class="form-control" name="category_product_keywords" id="exampleInputPassword1"
