                            ...
                            <form role="form" action="{{ URL::to('/update-product/' . $pro->product_id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length" data-validation-length="min10"
                                        data-validation-error-msg="Vui lòng điền tên sản phẩm ít nhất 10 ký tự"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="number"
                                        data-validation-error-msg="Vui lòng nhập số lượng sản phẩm" name="product_quantity"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="number"
                                        data-validation-error-msg="Vui lòng nhập giá tiền sản phẩm"
                                        value="{{ $pro->product_price }}" name="product_price" class="form-control"
