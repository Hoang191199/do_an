                        ...
                        <form role="form" action="{{ URL::to('/save-product') }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="length" data-validation-length="min10"
                                    data-validation-error-msg="Vui lòng điền tên sản phẩm điền ít nhất 10 ký tự"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="number"
                                    data-validation-error-msg="Vui lòng điền số lượng sản phẩm" name="product_quantity"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" data-validation="number"
                                    data-validation-error-msg="Vui lòng nhập số tiền sản phẩm" name="product_price"
                                    class="form-control" id="" placeholder="Tên danh mục" đ>
                            </div>
                            <div class="form-group">
