    ...
    <section id="cart_items">
        <div class="container-1">
            ...
            if ($message) {
                ...
                Session::put('message-1', null);
            }
            ?>
            <div class="register-req">
                <p>Làm ơn đăng ký hoặc đăng nhập để thanh toán giỏ hàng và xem lại lịch sử mua hàng.<br>Và điền đầy đủ thông
                    tin.</p>
            </div>
            <!--/register-req-->
                ...
                <div class="row">
                    <div class="col-sm-12 clearfix">
                        <div class="bill-to">
                            ...
                            <div class="form-one">
                                <form method="POST" class="send-order">
                                    @csrf
                                                ...
                                                <tr>
                                                    <td class="cart_product">
                                                        <img src="{{ asset('/uploads/product/' . $cart['product_image']) }}"
                                                            width="50px" alt="{{ $cart['product_name'] }}" />
                                                    </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.send-order').submit(function(event) {
